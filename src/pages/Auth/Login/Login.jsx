  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-lg w-full">
        ...
        >
          <div className="bg-gradient-to-r from-[#ff6a4a] to-orange-600 p-10 text-center">
            <h1 className="text-5xl font-black text-white">Welcome Back</h1>
            <p className="text-orange-100 mt-3 text-lg">Login to your account</p>
          </div>
          ...
          <div className="p-10">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-600 hover:text-[#ff6a4a] z-10"
                >
              ...
              <button
                type="submit"
                className="btn bg-[#ff6a4a] hover:bg-black text-white font-bold w-full h-14 text-xl rounded-full shadow-xl"
              >
                Login Now
              </button>
            </form>
            ...
            <div className="mt-10">
              ...
              <button
                ...
                className="mt-8 btn btn-outline w-full h-14 text-lg hover:bg-[#ff6a4a] hover:text-white font-semibold flex items-center justify-center gap-3"
              >
            ...
            <p className="text-center mt-10 text-gray-600 text-lg">
              New to StyleDecor?{" "}
              <Link to="/register" className="text-[#ff6a4a] font-bold hover:underline">
                Create an account
              </Link>
            </p>
          </div>
