...
const statusColors = {
  ...
  materials_prepared: "bg-violet-100 text-violet-700 border-violet-200",
  on_the_way: "bg-blue-100 text-blue-700 border-blue-200",
  setup_in_progress: "bg-fuchsia-100 text-fuchsia-700 border-fuchsia-200",
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-6 sm:py-8 px-4">
        ...
        >
          ...
          >
            <div className="text-4xl sm:text-6xl mb-4 text-gray-300">🗓️</div>
                  ...
                  <div className="p-4 sm:p-5">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5">
                      ...
                      <div className="flex flex-col justify-center items-center gap-4">
                        <motion.div
                          className="h-20 sm:w-24 sm:h-24 bg-[#ff6a4a]/5 border-2 border-dashed border-[#ff6a4a]/40 rounded-xl sm:rounded-2xl flex items-center justify-center text-xl sm:text-3xl text-[#ff6a4a]/60 w-full"
