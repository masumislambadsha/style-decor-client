...
const StatusBadge = ({ status }) => {
  ...
  return (
    <span className={`${base} bg-warning/10 text-warning border-warning/30`}>
    ...
    <div className="min-h-screen bg-base-200 py-6 sm:py-8 px-4">
                      ...
                      <div className="lg:col-span-2 space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div>
                            ...
                            <p className="text-base-content/80 text-xs sm:text-sm wrap-break-word">
                        ...
                        <div className="flex flex-wrap gap-2 sm:gap-4 text-xs sm:text-sm md:text-base">
                          ...
                          <div>
                            ...
                            <span className="font-mono font-semibold text-white px-2 py-1 rounded-xl sm:rounded-2xl bg-gray-800 dark:bg-gray-700">
                              {b.status === "assigned"
                                ? "Decorator Assigned"
                                : b.status === "cancelled"
                                ? "Cancelled"
      ...
      {selectedBooking && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 px-4">
          <motion.div
            className="bg-base-100 rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-lg p-4 sm:p-6 space-y-4"
              ...
              {decoratorsLoading ? (
                ...
                decorators.map((d) => (
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm border-b last:border-b-0 hover:bg-base-200 ${
